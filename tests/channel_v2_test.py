...
def test_success_with_pin_channel_message():
    ...
    pin_response = requests.put(config.url + 'message/pin/v1', json={'token': user1_data['token'],
...
def test_already_pinned_channel_message():
    ...
    requests.put(config.url + 'message/pin/v1', json={'token': user1_data['token'],
                                                                       'message_id': message_data['message_id']})
...
def test_not_owner_channel_message_pin():
    ...
    pin_response = requests.put(config.url + 'message/pin/v1', json={'token': user2_data['token'],
                                                                       'message_id': message_data['message_id']})
...
def test_not_valid_dm_pin():
    ...
    pin_response = requests.put(config.url + 'message/pin/v1', json={'token': user3_data['token'],
                                                                       'message_id': message_data['message_id']})
